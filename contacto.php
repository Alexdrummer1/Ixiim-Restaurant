		...
		<div class="col-contacto">
			...
			<div class="contacto-info">
				<div class="row-contacto">
                    ...
                    <br>México C.P. 97816</p>
                    <a href="https://www.google.com.mx/maps/place/Ixi'im+Restaurant/@20.755262,-89.8704077,17z/data=!3m1!4b1!4m5!3m4!1s0x8f561835ea57897d:0xbf787cf474bdbf7e!8m2!3d20.755262!4d-89.868219" target="_blank" class="ver-mapa">ver mapa completo</a>
				</div> <!-- /row-contacto -->
				...
				<div class="row-contacto">
					...
					Cena: 19:00 a 22:30</br>
					Jueves a Domingo</br>
					Comida: 13:00 a 17:00</br>
					Cena: 19:00 a 22:30</p>
				</div> <!-- /row-contacto -->
				
				<div class="row-contacto">
					<h2 class="location reser" data-location= "/reservaciones.php">Reservaciones</h2>
				</div> <!-- /row-contacto -->
				...
				<div class="row-contacto">
					<h2 class="location poli">Política de Privacidad</h2>
				</div> <!-- /row-contacto -->
			</div> <!-- /contacto-info -->
		</div> <!-- /col-reservacion -->
